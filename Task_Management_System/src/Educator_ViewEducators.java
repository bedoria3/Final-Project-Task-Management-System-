 ...
 */
public class Educator_ViewEducators extends javax.swing.JFrame {
    ...
    private void filtered(String query) {
        DefaultTableModel dm = (DefaultTableModel) educator_table.getModel();
        TableRowSorter<DefaultTableModel> tr = new TableRowSorter<DefaultTableModel>(dm);
        educator_table.setRowSorter(tr);
    ...
    private void showlist() {
        try {
            String query = "SELECT * FROM `educators_info";
            int s;
            try {
                ...
                DefaultTableModel model = (DefaultTableModel) educator_table.getModel();
                model.setRowCount(0);
                ...
                while (rs.next()) {
                    ...
                    for (int i = 1; i < +s; i++) {
                        v2.add(rs.getString("educator_id"));
                ...
                Logger.getLogger(Educator_ViewEducators.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void initComponents() {
        ...
        educator_table = new javax.swing.JTable();
        ...
        educator_table.setForeground(new java.awt.Color(117, 98, 122));
        educator_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        educator_table.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        educator_table.setRowHeight(18);
        educator_table.addContainerListener(new java.awt.event.ContainerAdapter() {
            public void componentAdded(java.awt.event.ContainerEvent evt) {
                educator_tableComponentAdded(evt);
            }
        });
        educator_table.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                educator_tableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(educator_table);
        ...
        jLabel18.setText("Educator's List");
        ...
        delete1.setBackground(new java.awt.Color(117, 98, 122));
            ...
            .addGroup(scholarsLayout.createSequentialGroup()
                ...
                .addGroup(scholarsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, scholarsLayout.createSequentialGroup()
                        ...
                        .addGap(57, 57, 57)
                        .addComponent(delete1, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(122, 122, 122)))
            ...
            .addGroup(scholarsLayout.createSequentialGroup()
                ...
                .addGroup(scholarsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(scholarsLayout.createSequentialGroup()
                        ...
                        .addGap(32, 32, 32))
                    .addGroup(scholarsLayout.createSequentialGroup()
                        .addGroup(scholarsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(scholarsLayout.createSequentialGroup()
                                .addComponent(searchfield, javax.swing.GroupLayout.PREFERRED_SIZE, 536, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(seacrh, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        scholarsLayout.setVerticalGroup(
            ...
            .addGroup(scholarsLayout.createSequentialGroup()
                ...
                .addGroup(scholarsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(seacrh, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(scholarsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(scholarsLayout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void educator_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_educator_tableMouseClicked

        DefaultTableModel model1 = (DefaultTableModel) educator_table.getModel();
        int selectIndex = educator_table.getSelectedRow();

        firstname.setText(model1.getValueAt(selectIndex, 1).toString());
        lastname.setText(model1.getValueAt(selectIndex, 2).toString());
        try {
            int srow = educator_table.getSelectedRow();
        ...
        address.setText(model1.getValueAt(selectIndex, 6).toString());
        email.setText(model1.getValueAt(selectIndex, 7).toString());
        password.setText(model1.getValueAt(selectIndex, 8).toString());

    }//GEN-LAST:event_educator_tableMouseClicked

    private void educator_tableComponentAdded(java.awt.event.ContainerEvent evt) {//GEN-FIRST:event_educator_tableComponentAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_educator_tableComponentAdded
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (dialogResult == JOptionPane.YES_OPTION) {
            try {
                ...
                String query = ("Delete from educators_info where educator_id =?");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost/task_system", "root", "");
            PreparedStatement pst = con1.prepareStatement("Update educators_info set first_name=?,last_name=?,birthdate=?,age=?,sex=?,address=?,email=?,password=? where educator_id= ?");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try {
            ...
            Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost/task_system", "root", "");
            PreparedStatement pst = con1.prepareStatement("insert into educators_info(first_name,last_name,birthdate,age,sex,address,email,password)values (?,?,?,?,?,?,?,?)");
            ...
            pst.executeUpdate();
            showlist();
            JOptionPane.showMessageDialog(null, "Educator's Added");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Educator_ViewEducators().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable educator_table;
