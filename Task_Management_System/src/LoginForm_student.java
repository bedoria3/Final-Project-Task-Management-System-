...
public class LoginForm_student extends javax.swing.JFrame {
    ...
    private void addscholarbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addscholarbuttonActionPerformed
        ...
        String query = "SELECT * FROM `scholars_info` WHERE `email` =? AND `password` =?";
        ...
        try {
            ...
            if (rs.next()) {
                ...
                Student_Dashboard ATG = new Student_Dashboard();
                ATG.setVisible(true);
                Student_Dashboard.displaystudentname.setText(rs.getString(1));
                ATG.showTasks();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        LoginForm_educator lp = new LoginForm_educator();
        lp.pack();
        lp.setVisible(true);
        this.dispose();
